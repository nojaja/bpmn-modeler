...
export class ZipAsPng {
  ...
  /**
   * disguise zip to png
   * @param {Buffer} zipBuff - Zip file Buffer.from(zipData, 'binary');
   * @param {Buffer} pngBuff - Png file Buffer.from(pngData, 'binary');
   */
  zipToPng (zipBuff, pngBuff) {
