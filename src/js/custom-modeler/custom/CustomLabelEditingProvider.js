...
export default function CustomLabelEditingProvider(
  ...
  eventBus.on('element.dblclick', function(event) {
    console.log('CustomLabelEditingProvider element.dblclick',event)
  ...
  function activateDirectEdit(element, force) {
    if (force ||
        isAny(element, [ 'bpmn:Task', 'custom:triangle', 'custom:circle', 'custom:image' ]) ||
        isCollapsedSubProcess(element)) {

      console.log('CustomLabelEditingProvider activateDirectEdit',element)
...
CustomLabelEditingProvider.prototype.activate = function(element) {
  ...
  console.log('CustomLabelEditingProvider activate',element)

  // href
  let href
  //image用の属性設定
  if (/custom:image$/.test(element.type)) {
    href = element.businessObject.href
  }
  console.log('CustomLabelEditingProvider activate href:',href)
  ...
  console.log('CustomLabelEditingProvider activate bounds:',bounds)
